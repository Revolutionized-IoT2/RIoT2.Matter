...
/// </summary>
/// <remarks>
/// Only the Standard commissioning flow (no embedded Vendor/Product id) is emitted, which is what
/// this sample advertises. A controller enters the grouped form <c>XXXX-XXX-XXXX</c>.
/// </remarks>
internal static class ManualPairingCode
{
    ...
    public static string Format(string code) =>
        code.Length == 11 ? $"{code[..4]}-{code.Substring(4, 3)}-{code[7..]}" : code;
