...
/// <summary>
/// The controller-facing fa�ade over a Matter Control Bridge (device type 0x0840): it composes the
...
public sealed class ControlBridgeService : IAsyncDisposable
{
    ...
    /// <see cref="AddBridgedDeviceAsync"/> / <see cref="RemoveBridgedDeviceAsync"/> fa�ade methods.
    /// </summary>
